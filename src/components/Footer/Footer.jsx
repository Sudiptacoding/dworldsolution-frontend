      ...
      <div className="relative z-10">
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-10 md:gap-0 mb-[60px] py-24">
            {/* Left: Logo Section */}
            <Link href="/" aria-label="Home" className="shrink-0 flex flex-col gap-8 items-start max-w-[450px]">
              <Image src="/image/Logo png.png" alt="Brand Logo" width={139} height={33} className="w-[200px] h-[40px] " />
            </Link>

            {/* Right: Link Section */}
            <div className="flex items-center justify-start w-full md:justify-end">
              <div className="flex flex-col items-start gap-6 md:flex-row md:items-center md:gap-10">
                <Link href="#Experience" className="text-sm font-normal text-gray-400 transition-colors duration-300 hover:text-white">
                  Terms & Conditions
                </Link>
                <Link href="#Feature-Section" className="text-sm font-normal text-gray-400 transition-colors duration-300 hover:text-white">
                  Refund Policy
                </Link>
                <Link href="#Extra" className="text-sm font-normal text-gray-400 transition-colors duration-300 hover:text-white">
                  Privacy Policy
                </Link>
              </div>
            </div>
          ...
          <div className="flex flex-col items-center justify-between gap-6 pb-10 md:flex-row">
            ...
            <div className="flex gap-[30px]">
              ...
              <a
                href="https://www.instagram.com/dworldsolution/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-[20px] inline-block transition-opacity duration-300 hover:opacity-70"
              >
                <img src="https://upload.wikimedia.org/wikipedia/commons/a/a5/Instagram_icon.png" alt="Instagram logo" width={20} height={20} />
              </a>
              <a
                href="https://www.facebook.com/DWorldSolutionVideoEditingAgency/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-[20px] inline-block transition-opacity duration-300 hover:opacity-70"
              >
