...
function Video() {
  ...
  const fetchVideos = async () => {
    const res = await axios.get("http://localhost:5000/header-video-upload");
    setVideos(res.data);
  };
  ...
  const handleUpload = async () => {
    ...
    await axios.post("http://localhost:5000/header-video-upload", {
      videoURL: url,
  ...
  const handleDelete = async (id) => {
    await axios.delete(`http://localhost:5000/header-video-upload/${id}`);
    fetchVideos();
  };
  ...
  const saveEdit = async () => {
    ...
    await axios.put(`http://localhost:5000/header-video-upload/${editingId}`, {
      src: editUrl,
      category: finalCategory,
